...
namespace rst
{
    ...
    public:
        ...
        ind_buf_id load_indices(const std::vector<Vector3i>& indices);
        col_buf_id load_colors(const std::vector<Vector3f>& colors);
        col_buf_id load_normals(const std::vector<Vector3f>& normals);
        ...
        void get_pixel(const Vector2i &point, Vector3f &color);
